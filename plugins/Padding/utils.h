...
#define MAX_TIMER 60 //Seconds before end of padding
#define BUFLO_TIMER 1000*1000 //Rate: Send packet every Buflo timer
#define HTB_RATE 1024 // record_size * 10^6 / buflo timerByte/second
